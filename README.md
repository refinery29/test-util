...
If you want to yield values from multiple data providers, but want to combine 
with some other values, use the `DataProviderTrait` along with the `Elements` data provider:
